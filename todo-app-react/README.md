...
**Note** If you want to use your `DGRAPH CLOUD ENDPOINT`, just login your dgraph cloud account [here](https://cloud.dgraph.io/) and copy the endpoint and replace the `localhost` endpoint.
